...
class AgentState(TypedDict, total=False):
    """LangGraph state schema for agentic orchestration.
    
    Fields are separated into overwrite vs append-only (Annotated with add reducer)
    to balance lean serializable state with full auditability.
    """
